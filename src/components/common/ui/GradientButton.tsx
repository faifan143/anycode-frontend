...
export const GradientButton: FC<GradientButtonProps> = ({
  ...
  <motion.button
    ...
    {...props}
  >
    <div className="absolute -inset-8 bg-gradient-to-r from-orange-600 to-orange-400 transition-all duration-300 group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-orange-500/20" />
